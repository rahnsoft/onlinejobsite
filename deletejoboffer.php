...
<div class="main">
	...
	<div class="content"><font color="white">
		<center>
		<h2 class="proh2" style="margin-bottom: 5px">Delete Job Offer</h2>
		<h4><?php echo $msg;?></h4>
